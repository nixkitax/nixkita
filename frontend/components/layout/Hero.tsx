...
const Hero = () => {
  return (
      <div className="px-4 mt-0 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 my-10">
        <a
          href="/blog"
          className="inline-flex mt-0 justify-between items-center px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700"
        >
